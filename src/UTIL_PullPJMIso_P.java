...
public class UTIL_PullPJMIso_P extends IEnbridgeWebServices
{
	...
	private final String strCaKeystorePath = "\\\\cnpl.enbridge.com\\apps\\mrmdev\\oldsystem\\endur\\main\\utilities\\ISO\\cert\\cacerts";
	private final String strCaKeystorePass = "changeit";

	private final String strClientKeystoreType = "PKCS12";
	private final String strClientKeystorePath = "\\\\cnpl.enbridge.com\\apps\\mrmdev\\oldsystem\\endur\\main\\utilities\\ISO\\cert\\mrm-oati-cert.pfx";
	...
	public void main(Table p_tblArguments, Table p_tblReturn) throws OException
	{
		...
		p_tblArguments.setString("config_file", 1, SystemUtil.getEnvVariable("AB_ENDUR_DIR") + "\\Main\\Utilities\\ISO\\config\\" + strPJMConfigFile);

		p_tblArguments.setInt("operation", 1, IEnbridgeWebServices.PJM_SOURCE);
		p_tblArguments.setString("iso_source", 1, "PJM");
		p_tblArguments.setString("save_path", 1, SystemUtil.getEnvVariable("AB_ENDUR_DIR") + "\\Main\\Utilities\\ISO\\data\\");
