/***********************************************************************************************************************************************
 * Filename: UTIL_PullNYIso_P.java
 * SVN: JVS\Utilities
 *
...
public class UTIL_PullNYIso_P extends IEnbridgeWebServices
{
	private final String strSavePath = "\\Main\\Utilities\\ISO\\data\\NYISO";
	private final String strDlUri = "https://dss.nyiso.com/dss/docViewAGN.jsp?RepoType=I&ID=";
	...
	private final String strRootUri = "https://dss.nyiso.com/dss/login.jsp?";
	private final String strUser = "louckda2";
	private final String strPass = "NYFiles2018";
	...
	{	
		...
		p_tblArguments.setString("dl_uri", 1, strDlUri);
		p_tblArguments.setInt("operation", 1, IEnbridgeWebServices.NYISO_SOURCE);
